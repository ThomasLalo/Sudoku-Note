...
export const oneBasedLookUpTable = [
	// could I have done this with an algorithm? yeah, but it would have taken me more time to write
	[
		[1, 1],
		[1, 2],
		[1, 3],
...
export function addBorders(
	borderColor: string,
	borderVar: string,
	borderPositions: string[][],
	elementNumber: number
): string {
	let returnString: string = '';
	for (const borderString of borderPositions[elementNumber]) {
		if (borderString !== '') {
